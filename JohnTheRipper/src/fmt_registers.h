...
john_register_one(&fmt_ocl_oldoff);
...
john_register_one(&fmt_opencl_cloudkeychain);
...
john_register_one(&fmt_opencl_lastpass);
...
john_register_one(&fmt_opencl_notes);
...
john_register_one(&fmt_opencl_pem);
...
john_register_one(&fmt_opencl_salted_sha1);
john_register_one(&fmt_opencl_sappse);
john_register_one(&fmt_opencl_sevenzip);
john_register_one(&fmt_opencl_sl3);
...
john_register_one(&fmt_opencl_vmx);
